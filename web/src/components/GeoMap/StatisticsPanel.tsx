    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="space-y-2">
          {topCountries.map(([countryCode, count]: [string, number]) => {
      ...
      <div>
        ...
        <div className="space-y-1 text-xs">
          <div className="flex items-center">
            <div className="w-3 h-3 bg-red-500 dark:bg-red-600 mr-2 rounded"></div>
            <span className="text-gray-700 dark:text-gray-300">High (&gt;10 logins)</span>
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 bg-amber-500 dark:bg-amber-600 mr-2 rounded"></div>
            <span className="text-gray-700 dark:text-gray-300">Medium (5-10 logins)</span>
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 bg-green-500 dark:bg-green-600 mr-2 rounded"></div>
            <span className="text-gray-700 dark:text-gray-300">Low (2-5 logins)</span>
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 bg-blue-500 dark:bg-blue-600 mr-2 rounded"></div>
